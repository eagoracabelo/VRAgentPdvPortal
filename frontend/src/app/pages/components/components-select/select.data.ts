import { Select2Data } from '@vrsoftbr/vr-components';
...
export const data5: Select2Data = [
  { value: 1, label: 'Revenda' },
  { value: 2, label: 'Matéria Prima' },
  { value: 3, label: 'Embalagem' },
  { value: 4, label: 'Semi Acabada' },
  { value: 5, label: 'Revenda2' },
  { value: 6, label: 'Revenda3' },
  { value: 7, label: 'Revenda4' },
];
