  ...
  describe('fixture', () => {
    ...
    describe('mouse event', () => {
      ...
      describe('move', () => {
        ...
        it('shoulb be call isEditColumn', () => {
          expect(directive.isEditColumn).toBeFalse();
          const isEditColumn = true;
          expect(isEditColumn).toBeTrue();
        });

        it('shoulb be call _moveColumn', () => {
          expect(directive._moveColumn).toBeFalse();
          const _moveColumn = true;
          expect(_moveColumn).toBeTrue();
        });
      });
    });
  });
