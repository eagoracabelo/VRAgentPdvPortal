...
@Component({
  selector: 'table-body-row',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './body-row.component.html',
})
export class TableBodyRowComponent implements DoCheck {
  ...
  calcStylesByGroup(group: string): {
    ...
    if (group === 'left') {
      ...
      const offset = (offsetDiff + this.scrollbarHelper.width) * -0.0625;
