...
import { TableBodyCellComponent } from './body-cell.component';
...
describe('TableBodyCellComponent', () => {
  ...
  describe('column input', () => {
    it('should receive a column object', () => {
      ...
      expect(component.column.width).toBe(col.minWidth);
    ...
    it('Should be calll', () => {
      ...
      const expectmask: FactoryOpts = {
        mask: /^\w+$/,
        autofix: true,
        lazy: true,
        overwrite: true,
        commit: (value: string, masked: any) => {
          masked._value = String(value).padStart(1 ?? 6, '0');
        },
      };
      const maskObj = { _value: '' };
      const mascara = component.mascara as any;
      mascara.commit('1', maskObj);
      expect((component.mascara as any).mask).toEqual(expectmask.mask);
      expect(component.mascara.commit).toBeInstanceOf(Function);
      expect(maskObj._value).toEqual('1');
    });
  });
  ...
  describe('Should match al column data types', () => {
    ...
    it('should be Data column', () => {
      ...
      expect(component.mascara.toString()).toEqual(
        TipoDadoColuna.data.mascara.toString(),
      );
    ...
    it('should be Hora column', () => {
      ...
      expect(component.mascara.toString()).toEqual(
        TipoDadoColuna.hora.mascara.toString(),
      );
    ...
    it('should be Data/Hora column', () => {
      ...
      expect(component.mascara.toString()).toEqual(
        TipoDadoColuna.dataHora.mascara.toString(),
      );
    ...
    it('should be Telefone column', () => {
      ...
      expect(component.mascara.toString()).toEqual(
        TipoDadoColuna.telefone.mascara.toString(),
      );
