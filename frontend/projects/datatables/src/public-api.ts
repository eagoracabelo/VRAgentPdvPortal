...
export * from './lib/components/footer/components/pager.component';
...
export * from './lib/components/row-add/row-add-template.directive';
export * from './lib/components/row-add/row-add.directive';
...
export * from './lib/vrc-datatables.module';
...
export * from './lib/services/table-page-screen.service';
...
// interfaces
export * from './lib/components/tools/interfaces/fire-event-button.interface';
export * from './lib/interfaces/export-all.interface';
export * from './lib/interfaces/page-info.interface';
export * from './lib/interfaces/sort.interface';

// enums
export * from './lib/enums/tokens.enum';
