...
export function optionalGetterForProp(
  prop: TableColumnProp,
): OptionalValueGetter | any {
  return prop && ((row: any): ValueGetter => getterForProp(prop)(row, prop));
}
...
export function groupRowsByParents(
  ...
  if (from && to) {
    ...
    nodeById[0].flatten(function (this: TreeNode): any {
...
class TreeNode {
  ...
  flatten(f: any, recursive: boolean): void {
