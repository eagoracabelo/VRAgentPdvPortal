...
@Component({
  ...
  template: `
    <vrc-datatable-group-header id="t1"></vrc-datatable-group-header>
    <vrc-datatable-group-header id="t2">
      <ng-template vrc-datatable-group-header-template></ng-template>
